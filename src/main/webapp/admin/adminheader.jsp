...
<title>헤더</title>
<style>
body, table, th, td, input, select, textarea, div, p, span, strong, b,
	i, ul, ol, li, button {
		...
		<div class="header-container d-flex align-items-center p-3">
			...
			<div class="header-links ml-3">
				<a href="https://counselors.or.kr/">한국상담학회</a> <span> · </span> <a
					...
					src="./img/kca_house.png" alt="KCA Logo">인트로
				</a>
			</div>
			<div class="header-right ml-auto d-flex align-items-center">
				<a><b>${member.member_name}</b> 님</a><a href="#">로그아웃</a><span
					class="mx-2"></span> <a href="#">마이페이지</a>
			</div>
		</div>
		<br>
